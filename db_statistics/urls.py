...
urlpatterns = [
    ...
    path("functions/list/", views.database_functions_list, name="database_functions_list"),
    ...
    path("maintenance/vacuum/", views.maintenance_vacuum, name="maintenance_vacuum"),
