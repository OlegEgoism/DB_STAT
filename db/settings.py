...
GOOGLE_DOCS_EXPORT_ENABLED = _env_bool("GOOGLE_DOCS_EXPORT_ENABLED", False)
GOOGLE_DOCS_DOCUMENT_ID = os.getenv("GOOGLE_DOCS_DOCUMENT_ID", "1TjXtsmYzJSrkRVHpG3PTSbHFlpNFK4WJEnKGRP-eNyM").strip()
GOOGLE_SERVICE_ACCOUNT_FILE = os.getenv("GOOGLE_SERVICE_ACCOUNT_FILE", "").strip()
GOOGLE_DOCS_TIMEOUT_SECONDS = int(os.getenv("GOOGLE_DOCS_TIMEOUT_SECONDS", "10"))
