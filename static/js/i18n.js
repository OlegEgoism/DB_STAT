(function () {
    ...
    const translations = {
        ...
        'Выберите вкладки, которые нужно показывать в боковом меню для текущего пользователя. Используйте стрелки, чтобы изменить порядок вкладок внутри каждого блока.': 'Select the tabs to show in the sidebar for the current user. Use the arrows to reorder tabs within each section.',
