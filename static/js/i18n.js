(function () {
    ...
    const translations = {
        ...
        'Временные таблицы': 'Temporary tables', 'Распределение': 'Distribution', 'Запросы': 'Queries', 'Активные запросы': 'Active queries', 'План запроса': 'Query plan',
        ...
        'Активные временные таблицы': 'Active temporary tables', 'Долгие запросы': 'Long-running queries', 'EXPLAIN без выполнения': 'EXPLAIN without execution',
        ...
        'Корневая операция': 'Root operation', 'Полная стоимость': 'Total cost', 'Оценка строк': 'Estimated rows', 'Ширина строки': 'Row width',
        'Дерево плана выполнения': 'Execution plan tree', 'Введите запрос и постройте его план': 'Enter a query and build its plan',
        'Построение плана запроса...': 'Building query plan...', 'Введите SQL-запрос': 'Enter an SQL query',
        'Выберите сохранённое подключение для построения плана': 'Select a saved connection to build a plan',
        'Не удалось построить план запроса': 'Failed to build query plan',
