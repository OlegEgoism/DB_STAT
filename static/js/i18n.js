(function () {
    ...
    const translations = {
        ...
        'Дополнительно': 'Additional', 'Порядок блоков': 'Section order',
        'Перетащите блоки, чтобы изменить последовательность их отображения.': 'Drag the sections to change their display order.',
