(function () {
    ...
    const translations = {
        ...
        'Группы': 'Groups', 'Обслуживание': 'Maintenance', 'Аудит': 'Audit', 'Избранные': 'Favorites', 'Настройки': 'Settings', 'Видео': 'Video',
        ...
        'Схема': 'Schema', 'Таблица': 'Table', 'Индексы': 'Indexes', 'Строк': 'Rows', 'Строки': 'Rows', 'Длительность': 'Duration', 'Избранное': 'Favorite', 'Тип объекта': 'Object type', 'Объект': 'Object', 'Идентификатор объекта': 'Object identifier',
    ...
    const patterns = [
        ...
        [/^От (\d+) до (\d+) часов\. После этого потребуется повторный вход\.$/, 'From $1 to $2 hours. You will need to sign in again after that.'],
