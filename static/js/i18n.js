(function () {
    ...
    const translations = {
        ...
        'Не удалось загрузить PDF-отчёты': 'Failed to load PDF reports',
        ...
        'Выбрать все': 'Select all', 'Сохранить': 'Save', 'Язык интерфейса сохранён': 'Interface language saved', 'Не удалось сохранить язык интерфейса': 'Failed to save interface language', 'Уведомление': 'Notification', 'Новое подключение': 'New connection',
        ...
        'Вход': 'Sign in', 'Выход': 'Sign out', 'Создание подключения': 'Connection creation', 'Изменение подключения': 'Connection update',
        'Удаление подключения': 'Connection deletion', 'Проверка подключения': 'Connection test', 'Настройки сайдбара пользователя': 'User sidebar settings',
        'Добавление в избранные объекты': 'Added to favorites', 'Удаление из избранных объектов': 'Removed from favorites',
        'Завершение активного запроса': 'Active query termination', 'Завершение активной сессии': 'Active session termination',
        'Завершение процесса блокировки': 'Lock process termination', 'Завершение простаивающей транзакции': 'Idle transaction termination',
        'Удаление временной таблицы': 'Temporary table deletion', 'Формирование PDF-отчёта': 'PDF report generation',
        'Завершить заблокированный': 'Terminate blocked', 'Завершить блокирующий': 'Terminate blocker',
        'Не удалось завершить процесс': 'Failed to terminate process',
        'Разделов': 'Sections', 'отчёт сформирован': 'report generated', 'успешно удалена': 'successfully deleted',
    ...
    Object.assign(translations, {
        ...
        'PDF-отчёт': 'PDF report', 'Отчет PDF': 'PDF report', 'Сформировать общий PDF-отчёт': 'Generate full PDF report', 'PDF-отчёт сформирован': 'PDF report generated', 'Не удалось сформировать PDF-отчёт': 'Failed to generate PDF report', 'Выберите подключение для формирования отчёта': 'Select a connection to generate a report',
    ...
    const patterns = [
        ...
        [/^Завершить процесс блокировки с PID (\d+)\?$/, 'Terminate lock process with PID $1?'],
        [/^Завершить простаивающую транзакцию с PID (\d+)\?$/, 'Terminate idle transaction with PID $1?'],
        [/^Завершить заблокированный процесс PID (\d+)$/, 'Terminate blocked process PID $1'],
        [/^Завершить блокирующий процесс PID (\d+)$/, 'Terminate blocking process PID $1'],
        [/^Завершить транзакцию PID (\d+)$/, 'Terminate transaction PID $1'],
        ...
        [/^Процесс блокировки с PID (\d+) завершён$/, 'Lock process with PID $1 was terminated'],
        [/^Транзакция с PID (\d+) завершена$/, 'Transaction with PID $1 was terminated'],
        [/^Процесс блокировки с PID (\d+) не найден$/, 'Lock process with PID $1 was not found'],
        [/^Транзакция с PID (\d+) не найдена$/, 'Transaction with PID $1 was not found'],
        [/^Не удалось завершить процесс блокировки с PID (\d+)$/, 'Failed to terminate lock process with PID $1'],
        [/^Не удалось завершить транзакцию с PID (\d+)$/, 'Failed to terminate transaction with PID $1'],
