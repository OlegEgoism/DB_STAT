(function () {
    ...
    const translations = {
        ...
        'Создавайте и редактируйте доступные размеры страниц. Допускается не более пяти вариантов.': 'Create and edit available page sizes. Up to five options are allowed.', 'Свернуть график': 'Collapse chart',
