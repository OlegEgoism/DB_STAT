(function () {
    ...
    const translations = {
        ...
        'Новая лицензия заменит текущую только после успешной проверки подписи и срока действия.': 'The new license will replace the current one only after its signature and validity period are verified.',
        'Активация DB STAT': 'DB STAT activation', 'Для первого запуска загрузите подписанный файл лицензии.': 'Upload a signed license file to start DB STAT for the first time.',
        'Файл лицензии': 'License file', 'Загрузить и активировать': 'Upload and activate',
        'Выберите файл лицензии': 'Select a license file', 'Файл лицензии слишком большой': 'The license file is too large',
        'Заменить лицензию может только Администратор': 'Only an Administrator can replace the license',
        'Лицензия не установлена': 'License is not installed', 'Лицензия активна': 'License is active',
        'Некорректный формат файла лицензии': 'Invalid license file format',
        'Файл предназначен для другого продукта или версии': 'The license file is intended for another product or version',
        'Открытый ключ лицензирования не настроен': 'The licensing public key is not configured',
        'Цифровая подпись лицензии недействительна': 'The license digital signature is invalid',
        'Уникальный хеш лицензии повреждён': 'The unique license hash is corrupted',
        'Дата окончания должна быть позже даты начала': 'The end date must be later than the start date',
        'Срок действия лицензии ещё не наступил': 'The license validity period has not started yet',
        'Срок действия лицензии истёк': 'The license has expired',
