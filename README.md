...
Если база данных была создана версией проекта без файлов миграций, сначала отметьте
начальную миграцию как применённую, а затем примените миграцию избранного:

```bash
python manage.py migrate --fake-initial
```

Команду необходимо выполнить после обновления проекта и до запуска сервера.
