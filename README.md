...
Суперпользователь Django Admin, логин: admin; пароль: admin; почта: admin@example.com
Пользователь приложения, логин: admin; почта: admin@example.com; роль: Администратор
```
