...
Для выбранного подключения доступен общий PDF-отчёт. В него входят общая
информация, размеры схем и крупнейших таблиц, временные таблицы, запросы,
сессии, блокировки, незавершённые транзакции, память, обслуживание,
пользователи и группы, сегменты Greenplum/Greengage и рекомендации. Скачать
документ можно кнопкой **«Скачать PDF»** во вкладке **«Аудит»**.
Если после обновления исходников приложение сообщает об отсутствии ReportLab,
обновите окружение командой `pip install -r requirements.txt` и перезапустите его.
