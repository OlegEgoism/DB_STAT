...
Мастер последовательно запросит пути к ключам, пароль закрытого ключа, название
организации, первый и последний дни действия и путь итогового `.license`-файла.
Если закрытого ключа ещё нет, мастер предложит создать новую пару Ed25519. Пароль
вводится скрыто и не сохраняется в `.env`.
